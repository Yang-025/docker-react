...
docker run -p 3000:3000 e55578311911

# -v /app/node_modules 表示以container裡的為主，外面的node_modules不會影響裡面的東西
docker run -p 3000:3000 -v /app/node_modules -v $(pwd):/app e55578311911

# 跑測試
docker exec -it d40a216c04c4 npm run test

#
docker attach 62b92c929562

# nginx
docker run -p 8080:80 b019b32a7785
---
